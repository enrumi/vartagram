    ...
    private final class Impl {
        ...
        private func updateHistoryViewRequest(reload: Bool) {
            ...
            if self.publicPosts {
                ...
                search = self.context.engine.messages.searchMessages(location: .general(scope: .everywhere, tags: nil, minDate: nil, maxDate: nil), query: self.query, state: nil, inactiveSecretChatPeerIds: self.context.currentInactiveSecretChatPeerIds.with { $0 })
            }
        ...
        func loadMore() {
            ...
            if self.publicPosts {
                ...
                search = self.context.engine.messages.searchMessages(location: .general(scope: .everywhere, tags: nil, minDate: nil, maxDate: nil), query: self.query, state: currentSearchState, inactiveSecretChatPeerIds: self.context.currentInactiveSecretChatPeerIds.with { $0 })
            }
